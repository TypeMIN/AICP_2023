...
from algorithm.bine_helper import graph
import random
from networkx.algorithms import bipartite as bi
import numpy as np
from algorithm.bine_helper.lsh import get_negs_by_lsh
from io import open
import os
import itertools
...
class GraphUtils(object):
    ...
    def homogeneous_graph_random_walks(self, percentage, maxT, minT):
        ...
        A = bi.biadjacency_matrix(self.G, self.node_u, self.node_v, dtype=float,weight='weight', format='csr')
    ...
    def get_random_walks_restart(self, datafile, hits_dict, percentage, maxT, minT):
        if datafile is None:
            datafile = os.path.join(self.model_path,"bine_train.dat")
