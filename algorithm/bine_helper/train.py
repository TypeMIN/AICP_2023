...
from algorithm.bine_helper.data_utils import DataUtils
from algorithm.bine_helper.graph_utils import GraphUtils
import random
import math
import os
import pandas as pd
...
def main():
    ...
    parser.add_argument('--train-data', default=r'../data/dblp/bine_train.dat',
                        help='Input graph file.')

    parser.add_argument('--test-data', default=r'../data/dblp/bine_test.dat')
