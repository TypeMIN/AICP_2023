import algorithm.deepcc_helper.core.general.param_init as pini
import tensorflow as tf

import algorithm.deepcc_helper.core.general.stat_lib as slib
...
class GMMEstimationNet:
    ...
    def run(self, x, keep_prob):
        ...
        # Layer 2
        z1_drop = tf.nn.dropout(z1, rate=1 - (keep_prob))
